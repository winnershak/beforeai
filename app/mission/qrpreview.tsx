...
import { StyleSheet, Text, View, TouchableOpacity, SafeAreaView, Alert, Vibration, Animated } from 'react-native';
          ...
          <View style={styles.content}>
            <View style={styles.missionInfo}>
              ...
              <Text style={styles.description}>
                Scan the QR code to complete your mission. Make sure you have the correct code ready.
              </Text>
            </View>
          </View>
