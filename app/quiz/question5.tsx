...
export default function QuizQuestion5() {
  ...
  const handleOptionSelect = (option: string) => {
    ...
    AsyncStorage.setItem('quiz_q5', option)
      .then(() => {
        router.push('/quiz/question6');
      })
      ...
      <View style={styles.overlay}>
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.content}>
            <Text style={styles.question}>How satisfied/dissatisfied are you with your sleep pattern in the last 2 weeks?</Text>
