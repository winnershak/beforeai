...
export default function QuizQuestion2() {
  ...
  const handleOptionSelect = (option: string) => {
    ...
    AsyncStorage.setItem('quiz_q2', option)
      .then(() => {
      ...
      <View style={styles.overlay}>
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.content}>
            <Text style={styles.question}>Do you have a consistent sleep schedule, or does it vary daily?</Text>
            
            {[
              'Consistent',
              'Varies on weekdays & weekends',
              'Mostly consistent but stay up late sometimes',
              'Inconsistent but I try',
              'Completely random'
            ].map((option) => (
              <TouchableOpacity
                key={option}
