...
import { View, Text, TouchableOpacity, StyleSheet, ImageBackground, Dimensions, Image, ActivityIndicator, Modal } from 'react-native';
...
export default function QuizQuestion1() {
  ...
  // Cache images on app start
  useEffect(() => {
    // Preload all quiz background images
    const images = [
      require('../../assets/images/1.png'),
      // ... add other quiz images
    ];
  }, []);
  ...
  const handleOptionSelect = (option: string) => {
    ...
    AsyncStorage.setItem('quiz_q1', option)
      .then(() => {
      ...
      <View style={styles.overlay}>
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.content}>
            <Text style={styles.question}>How many hours of sleep do you usually get?</Text>
